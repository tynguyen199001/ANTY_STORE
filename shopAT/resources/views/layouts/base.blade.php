				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+84) 36 840 100" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+84) 36 840 100</a>
								</li>
							</ul>
						</div>
					...
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home">
								...
								<h1><b style="color: red;">AT STORE</b></h1>
							</a>
						</div>
					...
					<div class="header-nav-section">
						<div class="container">
							<ul class="nav menu-nav clone-main-menu" id="mercado_haead_menu" data-menuname="Sale Info" >
								<li class="menu-item"><a href="#" class="link-term">Sản phẩm nổi bật</a><span class="nav-label hot-label">hot</span></li>
								<li class="menu-item"><a href="#" class="link-term">Sản phẩm giảm giá</a><span class="nav-label hot-label">hot</span></li>
								<li class="menu-item"><a href="#" class="link-term">Sản phẩm mới</a><span class="nav-label hot-label">hot</span></li>
								<li class="menu-item"><a href="#" class="link-term">Sản phẩm bán chạy</a><span class="nav-label hot-label">hot</span></li>
							</ul>
						</div>
					</div>
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="/checkout" class="link-term mercado-item-title">Thủ tục thanh toán</a>
								</li>
								<li class="menu-item">
					...
					<ul>
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">Miễn phí khi đặt hàng trên 1tr vnđ</p>
							</div>
						...
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">Thanh toán trực tuyến của bạn</p>
							</div>
						...
						<li class="fc-info-item">
							...
							<div class="wrap-left-info">
								...
								<p class="fc-desc">Chúng tôi có thể hỗ trợ 24/7</p>
							</div>
						</li>
					</ul>
				</div>
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">176 Tran Phu Hue City Viet Nam</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">(+84) 36 840 100</p>
											</li>
											<li>
												<i class="fa fa-envelope" aria-hidden="true"></i>
												<p class="contact-txt">ojt199001@gmail.com</p>
											</li>											
										</ul>
									</div>
								</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">(+84) 36 840 100</b>
									</div>
								</div>
							</div>
