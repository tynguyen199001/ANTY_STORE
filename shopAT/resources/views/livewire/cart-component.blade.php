        ...
        <div class="wrap-iten-in-cart">
            @if (Session::has('success_message'))
                <div class="alert alert-success">
                    <strong>Thành cô</strong>{{Sesion::get('success_message')}}
                </div>
            @endif
            @if(Cart::count() >0)
            ...
            <ul class="products-cart">
                ...
                <li class="pr-cart-item">
                    ...
                    <div class="price-field produtc-price"><p class="price">{{$item->model->regular_price}} vnđ</p></div>
                    <div class="quantity">
                    ...
                    <div class="price-field sub-total"><p class="price">{{$item->subtotal}}vnđ</p></div>
                    <div class="delete">
                ...
                <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                    ...
                    <div class="product product-style-2 equal-elem ">
                        ...
                        <div class="product-info">
                            ...
                            <div class="wrap-price"><span class="product-price">5.000.000 vnđ</span></div>
                        </div>
                    </div>
