			...
			<div class="wrap-main-slide">
				<div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
					<div class="item-slide">
						<img src="{{ asset('assets/images/banner_3.jpg')}}" alt="" class="img-slide">
						<div class="slide-info slide-1">
							<h2 class="f-title">Smart phone 2022 <b>Iphone 13</b></h2>
							<span class="subtitle">Sản phẩm chất lượng nhất của apple</span>
							<p class="sale-info">Giá chỉ: <span class="price">29.990.000 vnđ</span></p>
			...
			<div class="wrap-show-advance-info-box style-1 has-countdown">
				...
				<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
					...
					<div class="product product-style-2 equal-elem ">
						...
						<div class="product-info">
							<a href="#" class="product-name"><span>Radiant-360 R6 Wireless Omnidirectional Speaker [White]</span></a>
							<div class="wrap-price"><ins><p class="product-price">12000 vnđ</p></ins> <del><p class="product-price">$250.00</p></del></div>
						</div>
					</div>
